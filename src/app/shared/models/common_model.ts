...
export class Account_Model {
  ...
  public init() {
    this.Show_Ticket_Menu =
      this.Is_Full_Ticket ||
      this.Is_View_Ticket ||
      this.Is_Add_Ticket ||
      this.Is_Edit_Ticket ||
      this.Is_Delete_Ticket;
    this.Show_Ticket_Menu_Client =
      this.Is_Full_Ticket_Client ||
      this.Is_View_Ticket_Client ||
      this.Is_Add_Ticket_Client ||
      this.Is_Edit_Ticket_Client ||
      this.Is_Delete_Ticket_Client;
    this.Show_Summary_Menu =
      this.Is_Full_Summary ||
      this.Is_View_Summary ||
      this.Is_Add_Summary ||
      this.Is_Edit_Summary ||
      this.Is_Delete_Summary;
    this.Show_Solution_Menu =
      this.Is_Full_Solution ||
      this.Is_View_Solution ||
      this.Is_Add_Solution ||
      this.Is_Edit_Solution ||
      this.Is_Delete_Solution;
    this.Show_Solution_Menu_Client =
      this.Is_Full_Solution_Client ||
      this.Is_View_Solution_Client ||
      this.Is_Add_Solution_Client ||
      this.Is_Edit_Solution_Client ||
      this.Is_Delete_Solution_Client;
    this.Show_Admin_Menu =
      this.Is_Full_Admin ||
      this.Is_View_Admin ||
      this.Is_Add_Admin ||
      this.Is_Edit_Admin ||
      this.Is_Delete_Admin;

    if (this.Is_Agent_Original) {
      this.Show_Admin_Dashboard = true;
    } else {
      this.Show_Admin_Dashboard = false;
    }
  }
