...
import { Account_Model, Alert, AlertType, GridFilter, Menu_Model, Settings_Model } from './common_model';
@Injectable()
export class SystemService {
    ...
    constructor(public route: ActivatedRoute, public router: Router, public http: HttpClient) {
        ...
        this.Settings = <Settings_Model>{
            ...
            Expiration_Time: environment.Expiration_Time,
...
class DataHelper {
    ...
    public BearerToken = localStorage.getItem('token');
