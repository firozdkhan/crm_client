...
export class SalepaymentdueComponent {
  ...
  constructor(
    ...
    this.gridFilter.push(<GridFilter>{DisplayText: 'Total Amount',ColumnName: 'totalAmount',Type: 'number',Is_Visible: true,});
    this.gridFilter.push(<GridFilter>{DisplayText: 'Pay Amount',ColumnName: 'payAmount',Type: 'number',Is_Visible: true,});
    this.gridFilter.push(<GridFilter>{DisplayText: 'Balance Due',ColumnName: 'balanceDue',Type: 'number',Is_Visible: true,});
    this.gridFilter.push(<GridFilter>{DisplayText: 'Grand Total',ColumnName: 'grandtotal',Type: 'number',Is_Visible: true,});
